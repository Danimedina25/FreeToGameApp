...
class GetGameByIdUseCase @Inject constructor(private val repository: GamesRepository) {
    suspend operator fun invoke(idGame: Int): Flow<GameModel> {
        return repository.getGameById(idGame)
    }
}